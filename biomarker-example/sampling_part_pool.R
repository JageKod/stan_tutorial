...
# plotting stuff not needed in this script
  # patient to plot
patient_col <- 1
...
mod1 <- stan_model("model_part_pool.stan")
...
saveRDS(fit1, sprintf("fit_%s_%d_part_pool_%s.rds",experiment, number_of_patients, date))
